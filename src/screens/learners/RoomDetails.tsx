        ...
        <SafeAreaView className="flex flex-1 bg-[#F0EEEC] px-3">
            ...
            <ScrollView horizontal={false} className="space-y-4 mb-10">
                <View className="flex flex-row justify-between">
                    <Text className="p-3 bg-[#ACE5FF] text-[#005DB2] text-base w-[45%] rounded-lg text-center font-bold">
                        B1 - Intermediate
                    </Text>
                    <Text className="p-3 bg-[#F2DDCC] text-[#FF6B00] text-base w-[45%] rounded-lg text-center font-bold">
                        Daily life
                    </Text>
                </View>
                ...
                >
                    <View className="flex flex-row justify-between items-center">
                        <Text className="text-[#005DB2] font-bold text-lg">SPEAKERS</Text>
                        <TouchableOpacity
                        ...
                        >
                            ...
                            <Text className="text-[#005DB2] text-lg font-bold">3</Text>
                        </TouchableOpacity>
                    </View>
            ...
            >
                <View className="w-[100%] h-[70%] bg-white flex rounded-xl p-4 flex-col items-center">
                    <Text className="text-xl font-medium text-sky-700">Listeners</Text>
