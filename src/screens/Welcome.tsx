        ...
        <SafeAreaView className='flex-1 bg-neutral-100'>
            <View className='flex-1 flex justify-around my-4'>
                <View className='flex-row justify-center'>
                    <Image source={require('@asset/images/logo.png')} style={{resizeMode: 'contain', width: '85%'}}/>
                </View>
                ...
                <View className='flex-row justify-center'>
                    ...
                    <TouchableOpacity>
                        <Text className='font-semibold text-yellow-400' onPress={() => navigation.navigate('SignIn')}>Log In</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </SafeAreaView>
