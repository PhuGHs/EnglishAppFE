        ...
        <SafeAreaView className='flex-1 bg-neutral-100 px-4 space-y-4 flex justify-between'>
            <View>
                <View className='flex flex-row mb-5 items-center'>
                    ...
                    <Text className='text-center w-full -left-[35px] text-sky-600 text-[22px] font-medium'>Assessment Test</Text>
                </View>
                <View className='flex flex-col gap-4'>
                    ...
                    <View className='flex w-full relative'>
                        <Image className='absolute top-0 left-0' source={require('@asset/images/Test.png')} style={{resizeMode: 'contain', width: '100%'}}/>
                    </View>
                </View>
            </View>
            <View className='flex flex-col gap-3'>
                ...
                <TouchableOpacity className='rounded-2xl bg-yellow-400 p-4 mb-5 flex justify-center items-center' onPress={() => navigation.navigate('QuestionsScreen')}>
