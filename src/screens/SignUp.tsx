            ...
            <View className='bg-white h-[70%] rounded-t-3xl p-5 flex flex-col space-y-1'>
                <View className='flex flex-row space-x-3'>
                    <View className='flex flex-col gap-2 w-[48%]'>
                        ...
                        <TextInput className='p-4 bg-gray-100 text-gray-700 rounded-2xl text-lg' value='Lê Văn'/>
                    </View>
                    <View className='flex flex-col gap-2 w-[48%]'>
                        <Text className='text-gray-700 font-bold text-lg'>Last Name</Text>
                        <TextInput className='p-4 bg-gray-100 text-gray-700 rounded-2xl text-lg' value='Phú'/>
                    </View>
                </View>
                <View className='flex flex-col gap-2 w-full'>
                    <Text className='text-gray-700 font-bold text-lg'>Email Address</Text>
                    <TextInput className='p-4 bg-gray-100 text-gray-700 rounded-2xl text-lg' value='levanphu2003@gmail.com' placeholder='Enter your email'/>
                </View>
                <View className='flex flex-col gap-2 w-full'>
                    <Text className='text-gray-700 font-bold text-lg'>Password</Text>
                    <TextInput secureTextEntry className='p-4 bg-gray-100 text-gray-700 rounded-2xl text-lg' value='vanphudh2003' placeholder='Enter your password'/>
                </View>
                <View className='flex flex-col gap-2 w-full'>
                    <Text className='text-gray-700 font-bold text-lg'>Confirmed password</Text>
                    <TextInput secureTextEntry className='p-4 bg-gray-100 text-gray-700 rounded-2xl text-lg' value='vanphudh2003' placeholder='Confirm your password'/>
                </View>
                <View>
