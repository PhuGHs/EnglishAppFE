        ...
        <SafeAreaView className='flex bg-sky-400 flex-1 justify-between'>
            ...
            <View className='bg-white h-[55%] rounded-t-3xl p-8 flex flex-col space-y-4'>
                ...
                <View className='flex flex-col items-end mt-2'>
                    <TouchableOpacity>
                        <Text className='font-semibold text-md text-gray-700'>Forgot password?</Text>
                    </TouchableOpacity>
                </View>
                <View>
                    <TouchableOpacity className='py-3 bg-yellow-400 rounded-xl' onPress={() => navigation.navigate('Interest')}>
