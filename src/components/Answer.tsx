        ...
        <View className='flex flex-row py-4 border-b-[1px] border-gray-400'>
            ...
            <View className='w-[83%] flex flex-col justify-center items-start'>
                <TouchableOpacity className='flex flex-row space-x-2 items-center'>
                    <Text className='text-lg font-nunitoBold text-gray-700'>{answer.user.full_name}</Text>
                    <Text className='text-base font-nunitoSemi text-gray-400'>{Helper.calculateTimeAgo(answer.created_date)}</Text>
                </TouchableOpacity>
                <View>
