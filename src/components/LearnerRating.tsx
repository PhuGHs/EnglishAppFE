...
const LearnerRating = () => {
    return (
        <View className='p-4 flex w-full h-fit bg-white rounded-2xl' style={{elevation: 15}}>
            ...
            <Text className='p-2 text-base font-nunitoMedium text-gray-700'>An absolutely wonderful car to drive. Simply lovely! Sometimes it's almost too easy to drive.</Text>
